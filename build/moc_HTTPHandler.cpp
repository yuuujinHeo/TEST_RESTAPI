...
QT_MOC_LITERAL(1, 12, 8), // "post_out"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 8), // "reply_in"
QT_MOC_LITERAL(4, 31, 7) // "onCheck"

    },
    "HTTPHandler\0post_out\0\0reply_in\0onCheck"
};
...
void HTTPHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->post_out(); break;
        case 1: _t->reply_in(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HTTPHandler::post_out)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (HTTPHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HTTPHandler::reply_in)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void HTTPHandler::post_out()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void HTTPHandler::reply_in()
{
